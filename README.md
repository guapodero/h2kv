...
* Facilitate portability by minimizing backend-specific knowledge.
The only semantics involved are that of hash tables, HTTP, and JSON.
...
This would not be possible without the work of Zhang Xin and Florian Gilcher to build the
[Rust bindings for LevelDB](https://github.com/rim99/leveldb-rs-binding).
